...
parser.add_argument('--model', type=str, required=True, default='Autoformer',
                    help='model name, options: [Autoformer, Informer, Transformer, TabPFN_ts]')
...
parser.add_argument('--target', type=str, default='incidenza', help='target feature in S or MS task')
